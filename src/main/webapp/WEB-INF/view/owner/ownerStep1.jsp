...
<!-- Navigation Bar -->
<div class="step1Form1">
	<form action="ownerStep2" method="post">
		<div class="step1Form2">
			<textarea rows="20" cols="70">
				<제 1 장 총 칙> 제 1 조 (목적)
펜션나라 (이하 "회사"라 함)와 이용 고객(이하 '회원')간에 회사가 제공하는 와라펜션의 서비스(한글명:펜션나라, 이하 서비스)의 가입조건 및 이용에 관한 제반 사항과 기타 필요한 사항을 구체적으로 규정함을 목적으로 합니다.

제 2 조 (이용약관의 효력 및 변경)
(1) 이 약관은 와라펜션 웹사이트(http://www.warapension.co.kr 이하 '와라펜션 웹')에서 온라인으로 공시함으로써 효력을 발생하며, 합리적인 사유가 발생할 경우 관련법령에 위배되지 않는 범위 안에서 개정될 수 있습니다. 개정된 약관은 온라인에서 공지함으로써 효력을 발휘하며, 이용자의 권리 또는 의무 등 중요한 규정의 개정은 사전에 공지합니다.
